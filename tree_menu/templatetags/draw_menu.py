...
# Импорт исключения, когда ожидаемый объект не найден
...
def get_selected_item_id_list(parent: MenuItem, primary_item: List[MenuItem], selected_item_id: int) -> List[int]: # noqa
    """
    Returns a list of IDs for the selected menu items,
    starting from the parent item to the current one.
